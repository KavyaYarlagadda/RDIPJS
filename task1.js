...
function res(){
    ...
    if(r1==true&&r2==true&&r3==true){
        document.getElementById("task").innerHTML = "Details mentioned above are correct "
    }
    else{
        document.getElementById("task").innerHTML = "please give correct details "
    }
